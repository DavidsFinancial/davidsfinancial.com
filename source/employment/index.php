...
<head>
    ...
    <title>Employment Opportunities | Davids Financial</title>
...
<div id="divCONTAINER">
    ...
    <div id="divBODY">
        <div class="innerContainer">
            <div class="title">EMPLOYMENT OPPORTUNITIES</div>
            <div class="col1">
                        ...
                        <p>
                            ...
                            <div class="table" style="margin: 0; padding-top: 0; font-size: 95%;">
                                <div class="col_single">
                                    ...
                                    <div class="item">Achieve referral and scorecard goals</div>
                            ...
                            <div class="table" style="margin: 0; padding-top: 0; font-size: 95%;">
                                <div class="col_single">
                                    ...
                                    <div class="item">Customer service orientation</div>
                                    <div class="item">Excellent verbal and written communication skills</div>
                                    <div class="item">Analytical and problem solving skills</div>
                                    <div class="item">Basic computer skills- Windows based applications and Teller POS workstation (Tellermetrix system)</div>
                                    <div class="item">Ability to use: Telephone, Fax, Copier, Calculator</div>
