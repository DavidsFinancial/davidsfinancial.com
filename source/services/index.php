    ...
    <div id="divBODY">
        <div class="innerContainer">
            ...
            <div class="col1">
                ...
                <div class="content indent">
                    2. <strong>Download the App</strong> - A David's associate will text you a link to download the Davids app
                </div>
                <div class="content indent">
                    3. <strong>Sign Up</strong> - Activate your David's App
                </div>
                <div class="content indent">
                    4. <strong>Submit Your Checks Remotely</strong> - Now you can quickly submit your checks, pay bills, purchase money orders, load/unload debit cards and stage Western Union Money Transfers.  Anytime! Anywhere!
                </div>
                <div class="content indent">
                ...
                <div class="content lottery"><img src="<?php echo $url_prefix; ?>_images/partners3.png" alt="MetroCard logo"></div>
                <div class="sectionTitle"><div class="iconBullet"></div>E-Z PASS&reg; ON-THE-GO (Available in Rockland County Locations only)</div>
                ...
                <div class="content indent">
                    3. Visit the E-ZPass website and register your tag within 48 hours of its first use to get credit for your full purchase price.
                </div>
                <div class="content">
